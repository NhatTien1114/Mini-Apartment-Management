...
public class PhuongTienDAO {
    ...
    public boolean kiemTraBienSoTonTai(String bienSo) {
        String sql = "SELECT COUNT(*) FROM PhuongTien WHERE bienSo = ?";
        try (Connection con = connectDB.getConnection();
                PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            System.err.println("Loi kiemTraBienSoTonTai: " + e.getMessage());
        }
        return false;
    }
